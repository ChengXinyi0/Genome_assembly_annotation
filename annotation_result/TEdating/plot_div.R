...
#setwd("/data/users/rschwob/01_assembly_annotation_course/results/6_dynamics_of_TEs_1_dating")
...
rep_table.m <- rep_table.m %>%
    mutate(Superfamily = case_when(
        ...
        Rfam == "DTC" ~ "DNA/DTC",
        Rfam == "DTA" ~ "DNA/DTA",
        Rfam == "DTC" ~ "DNAauto/CACTA",
        Rfam == "DTC" ~ "DNAauto/CACTG",
        Rfam == "DTA" ~ "DNAauto/hAT",
        Rfam == "DTM" ~ "DNAauto/MLE",
        Rfam == "DTM" ~ "DNAauto/MULE",
        Rfam == "DTH" ~ "DNAauto/PILE",#?
        Rfam == "DTH" ~ "DNAauto/POLE",
        Rfam == "DTC" ~ "DNAnona/CACTA",
        Rfam == "DTA" ~ "DNAnona/hAT",
        Rfam == "DTM" ~ "DNAnona/MLE",
        Rfam == "DTM" ~ "DNAnona/MULE",
        Rfam == "DTM" ~ "DNAnona/MULEtir",
        Rfam == "DTH" ~ "DNAnona/PILE",
        Rfam == "unknown" ~ "MITE/Stow",
        Rfam == "unknown" ~ "MITE/Tourist",
        Rfam == "unknown" ~ "repeat"
    ))
...
rep_table.m$Superfamily <- factor(rep_table.m$Superfamily, levels = c(
    ...
    "DNA/DTT", "LINE", "DNAauto/CACTA","DNAauto/CACTG","DNAauto/hAT",
    "DNAauto/MLE","DNAauto/MULE","DNAauto/PILE","DNAauto/POLE","DNAnona/CACTA",
    "DNAnona/hAT","DNAnona/MLE","DNAnona/MULE","DNAnona/MULEtir","DNAnona/PILE",
    "MITE/Stow", "MITE/Tourist","repeat"
))
...
ggsave(filename = "TE-myr_new.pdf", width = 10, height = 5, useDingbats = F)
