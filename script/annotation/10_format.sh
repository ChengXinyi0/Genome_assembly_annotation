...
#SBATCH --output=/data/users/xcheng/assembly_annotation_course/annotation/logs/format_%j.o
#SBATCH --error=/data/users/xcheng/assembly_annotation_course/annotation/logs/format_%j.e
